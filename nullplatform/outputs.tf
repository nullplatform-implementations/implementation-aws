...
# carries the catalog metadata (repository_org/name, service_path, version) and
# the package published for it, so consumers can derive paths/URLs from a
# single ${org}/${name} if they want to.
################################################################################
